...
public class GraphEquivalenceMatcher extends ObjectAlignment implements AlignmentProcess {
	...
	public GraphEquivalenceMatcher(OWLOntology sourceOntology, OWLOntology targetOntology, double weight) {
	...
	public static void main(String[] args) throws OWLOntologyCreationException, AlignmentException, URISyntaxException, IOException {
		...
		AlignmentProcess a = new GraphEquivalenceMatcher(sourceOntology, targetOntology, testWeight);
		...
		try {
			...
			for ( Object cl2: ontology2().getClasses() ){
				for ( Object cl1: ontology1().getClasses() ){
					...
					addAlignCell("GraphMatcher" + idCounter, cl1,cl2, "=", computeStructProx(cl1,cl2, onto1Graph, onto2Graph)); 
				}
