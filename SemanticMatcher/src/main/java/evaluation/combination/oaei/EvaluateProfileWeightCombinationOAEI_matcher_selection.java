...
public class EvaluateProfileWeightCombinationOAEI_matcher_selection {
	...
	public static void main(String[] args) throws OWLOntologyCreationException, JWNLException, IOException, AlignmentException, URISyntaxException {
		...
		String mismatchStorePath = "./files/_PHD_EVALUATION/OAEI2011/ALIGNMENTS/" + ontos + "/MISMATCHES/MISMATCHES_WITH_MATCHER_SELECTION";
		...
		for (double conf : confidence) {
			...
			outputAlignment = new File("./files/_PHD_EVALUATION/"+DATASET+"/ALIGNMENTS/"+ontos+"/PROFILEWEIGHT_MATCHER_SELECTION/PROFILEWEIGHT_MERGED_SIGMOID_"+DATASET+"_"+ontos+"_"+conf+".rdf");
